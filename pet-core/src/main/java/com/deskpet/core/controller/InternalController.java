...
public class InternalController {
    ...
    public InternalController(DeviceService deviceService, TelemetryService telemetryService, CommandService commandService) {
    ...
    @GetMapping("/auth")
    public ResponseEntity<String> auth(@RequestParam String deviceId, @RequestParam String secret) {
    ...
    public ResponseEntity<Void> telemetry(@PathVariable String deviceId, @RequestBody TelemetryRequest request) {
        telemetryService.updateLatest(deviceId, request.toMap());
        return ResponseEntity.accepted().build();
    }

    @PostMapping("/ack/{deviceId}")
    public ResponseEntity<Void> ack(@PathVariable String deviceId, @RequestBody AckRequest request) {
